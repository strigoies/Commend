...
export const constantRouterMap = [
  ...
  },
  {
    ...
    name: '保险设置管理',
    meta: { title: '保险设置管理', icon: 'example' },
    children: [
      {
        path: 'list',
        name: '保险设置列表',
        component: () => import('@/views/hospset/list'),
        meta: { title: '保险设置列表', icon: 'table' }
      },
      {
        path: 'add',
        name: '保险设置添加',
        component: () => import('@/views/hospset/add'),
        meta: { title: '保险设置添加', icon: 'tree' }
      },
      {
        path: 'edit/:id',
        name: 'EduTeacherEdit',
  ...
  }, 
  {
    path: '/viewsta',
    component: Layout,
    redirect: '/viewsta/table',
    name: '浏览量统计',
    alwaysShow: true,
    meta: { title: '浏览量统计', icon: 'example' },
    children: [
      {
        path: 'list',
        name: '浏览量统计',
        component: () => import('@/views/viewsta/PanelGroup'),
        meta: { title: '浏览量统计', icon: 'table' }
      }
    ]
  },
  // {
