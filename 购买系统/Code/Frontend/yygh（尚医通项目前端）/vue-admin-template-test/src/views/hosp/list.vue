<template>
  <div class="app-container">
    <el-form :inline="true" class="demo-form-inline">
      ...
      <el-form-item>
        <el-input v-model="searchObj.hosname" placeholder="保险名称" />
      </el-form-item>
    ...
    >
      ...
      <el-table-column prop="hosname" label="保险名称" />
      <el-table-column prop="param.hostypeString" label="保障项目" width="90" />
      <el-table-column prop="param.fullAddress" label="行业" />
...
export default {
  ...
  methods: {
    ...
    //查询所有的省
    findAllProvince() {
      hospApi.findByDictCode("Hostype").then((response) => {
