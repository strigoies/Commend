<template>
  ...
  <el-menu-item  @click="handleproduct" index="1">产品中心</el-menu-item>
  <el-submenu index="2">
  ...
  <el-menu-item  @click="handleorder" index="4"><a href="https://www.ele.me" target="_blank">订单管理</a></el-menu-item>
</el-menu>
<div class="line"></div>
