  ...
  <div class="app-container">
     <el-form label-width="80px" label-height="30px">
      ...
      <el-form-item label="用户名">
        ...
        <el-input v-model="teacher.mobile"  style="width:15%"> 
        </el-input>
        </el-form-item>
      ...
      <el-form-item label="年龄" >
        <el-input v-model="teacher.age" controls-position="right" style="width:100px" size="medium"/>
      </el-form-item>
    ...
    updateTeacher() {
      userApi.updateTeacherInfo(this.teacher)
        .then(response => {
          ...
          //回到列表页面 路由跳转
          this.$router.push({path:'/userManager/table'})
        })
    },
