...
// <script>
// import Hot from '@/views/data/Hot.vue'
// import Map from '@/views/data/Map.vue'
// import Rank from '@/views/data/Rank.vue'
// import Seller from '@/views/data/Seller.vue'
// import Stock from '@/views/data/Stock.vue'
// import Trend from '@/views/data/Trend.vue'
